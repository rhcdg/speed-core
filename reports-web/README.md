...
# speed-reports-web service

This is the microservice representing the front end web interface for the Reporting Portal
...
* CODE REVIEWS: https://github.com/Steampunk-SPEED/speed-reports-web/pulls?q=is%3Apr+is%3Aclosed
* SONARQUBE METRICS: https://sonarqube.speedc2c24.steampunkfoundry.net/dashboard?id=speed%3Areports-web
* JENKINS BUILDS (TEST EXECUTION): https://jenkins-ci.speedc2c24.steampunkfoundry.net/job/Microservices%20Pipeline/job/speed-reports-web/
...
This microservice could easily be deployed in USCIS's Openshift Containerized Platform.
