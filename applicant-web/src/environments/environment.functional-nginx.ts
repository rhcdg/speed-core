...
export const environment = {
  production: false,
  accountServiceURL: '/users/api/account',
  formsServiceURL: '/documents/api/data/forms',
  postFormServiceURL: '/documents/api/form',
  analytics: {
  ...
  cognito: {
    ...
    redirect_uri:
      'https://speed-applicant-web-functional.speedc2c24.steampunkfoundry.net/callback',
    response_type: 'code',
    metadata: {
