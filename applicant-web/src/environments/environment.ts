...
export const environment = {
  production: false,
  accountServiceURL: 'http://localhost:9080/users/api/account',
  formsServiceURL: 'http://localhost:9080/documents/api/data/forms',
  postFormServiceURL: 'http://localhost:9080/documents/api/form',
  analytics: {
