...
Postgres database for use in the technical challenge 
...
### Build the Image
```
docker build -t techdemo/techdemo-pg .
```

### Run the Container
```
docker run --rm -d -p 5432:5432 techdemo/techdemo-pg
```
...
* CODE REVIEWS: https://github.com/Steampunk-SPEED/speed-postgres/pulls?q=is%3Apr+is%3Aclosed
...
This container could easily be added to any USCIS openshift cluster
